...
define("hr.timedtrigger", ["require","exports","hr.eventdispatcher"], function (require, exports, hr_eventdispatcher_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var TimedTrigger = /** @class */ (function () {
        function TimedTrigger(delay) {
            this.handler = new hr_eventdispatcher_5.ActionEventDispatcher();
            if (delay === undefined) {
                delay = 400;
            }
            this.delay = delay;
